...
This folder now contains a static visual-library prototype built from the curation brief, with 28 reusable wave-driven entries across motion, type, grid, color, texture, interface, state, and layout.
...
- category tags and filter/search controls
